...
@Composable
fun TempderatureGraph(
    state: HomeListState,
    modifier: Modifier = Modifier
) {
    val context = LocalContext.current
    val tempDataPoints = state.temperatureDataPoints
    val tempDatePoints = state.tempDatePoints
...
//        maxValue = tempDataPoints.max(),
//        minValue = tempDataPoints.min(),
    )
}